...
import {calcUploadMaxConcurrency, calcSmoothSpeed, removeItem} from '../utils/LoadUtil'
...
export class BaseUploader extends BaseLoader {
  ...
  async http_client_call(action, opt, options = {}, retry = 3, retry2 = 50) {
    ...
    try {
      ...
      if (e.code != 'stopped' && e.message != 'stopped') console.warn(action, 'ERROR:', e.response || e)

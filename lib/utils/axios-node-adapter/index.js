...
var platform = require('axios/lib/platform')
var fromDataURI = require('axios/lib/helpers/fromDataURI')
var stream = require('stream')
var estimateDataURLDecodedBytes = require('axios/lib/helpers/estimateDataURLDecodedBytes.js')
...
export default function httpAdapter(config) {
  return new Promise(function dispatchHttpRequest(resolvePromise, rejectPromise) {
    ...
    var req = transport.request(options, function handleResponse(res) {
      ...
      if (responseType === 'stream') {
        ...
        responseStream.on('aborted', function handlerStreamAborted() {
          ...
          responseStream.destroy()
          reject(new AxiosError('response stream aborted', AxiosError.ECONNABORTED, config, lastRequest))
        })
    ...
    if (config.timeout) {
      ...
      if (isNaN(timeout)) {
        reject(
          new AxiosError('error trying to parse `config.timeout` to int', AxiosError.ERR_BAD_OPTION_VALUE, config, req),
        )

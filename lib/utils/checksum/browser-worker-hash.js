...
export {worker_calc_file_hash, worker_calc_file_parts_hash, worker_calc_file_crc64}

async function worker_calc_file_crc64(file, onProgress, getStopFlag) {
  return await workerCalcFileHash({calcType: 'crc64', file}, onProgress, getStopFlag)
}

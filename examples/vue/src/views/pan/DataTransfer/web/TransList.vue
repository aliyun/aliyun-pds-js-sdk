          ...
          <a-list-item class="trans-list-item">
                ...
                <div class="d-flex">
                  ...
                  <div class="text-w ml-10" style="min-width: 220px">
                    ...
                    >
                      ...
                      <template #title> 失败: {{ item.error.message }} </template>
                    </a-tooltip>
                  </div>
                </div>
              </template>
            ...
            <template #actions>
              <div class="text-right ml-0 mr-0" style="max-width: 80px">
                ...
                <CheckCircleOutlined class="success-text mx-6" v-if="SUCCESS_STATES.includes(item.state)" />
              </div>
            </template>
            <!-- 进度 -->
...
import {PlayCircleOutlined, PauseCircleOutlined, CheckCircleOutlined, CloseCircleOutlined} from '@ant-design/icons-vue'
